...
#logging config
logger = logging.getLogger("data_preprocessing")            #naming the logger object data_ingestion
...
def transform_text(text):
    '''Transform the input text by converting it to lowercase, tokenizing removing stopwords and punctuations and steming'''
    ps = PorterStemmer()
...
#text ='My name is Joy. I am the king of good times, very lucky to be able to work here - dreaming everyday of future'
